...
const TEXT_EXT = /\.(txt|md|markdown|csv|tsv|json|ya?ml|xml|html?|css|scss|js|mjs|cjs|ts|tsx|jsx|py|rb|go|rs|java|kt|c|cc|cpp|h|hpp|sh|bash|zsh|sql|toml|ini|conf|cfg|log|env|gitignore|dockerfile)$/i;
...
async function imageToAttachment(file, name) {
...
async function textToAttachment(file) {
...
export function toApiContent(content, attachments) {
